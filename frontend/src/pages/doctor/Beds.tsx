  ...
  return (
    <MainLayout>
      <div className="p-4 lg:p-8 pt-16 lg:pt-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-foreground">ICU Bed Management</h1>
          <p className="text-muted-foreground mt-1">
            Overview of all ICU bed availability and assignments
          </p>
        </div>
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  bed.isOccupied
                    ? 'border-primary/20 bg-card cursor-pointer hover:border-primary/40'
                    : 'border-status-normal/20 bg-status-normal-bg/30'
                )}
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    >
                      {bed.isOccupied ? (
                        ...
                        <BedDouble className="h-6 w-6 text-status-normal" />
                      )}
                    </div>
                    <div>
                  ...
                  <span
                    className={cn(
                      ...
                      bed.isOccupied ? 'bg-primary' : 'bg-status-normal'
                    )}
                  />
                </div>
