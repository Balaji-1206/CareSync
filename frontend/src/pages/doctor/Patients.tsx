                      ...
                      <div className="flex items-center gap-3">
                        <div
                          className={cn(
                            ...
                            patient.status === 'normal' && 'bg-status-normal/10 text-status-normal',
                            patient.status === 'warning' && 'bg-status-warning/10 text-status-warning',
                            patient.status === 'critical' && 'bg-status-critical/10 text-status-critical'
                          )}
                        >
